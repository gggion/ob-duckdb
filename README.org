...
#+begin_quote
[!TIP]
You can check out more examples for all ob-duckdb functionalities in [[docs/ob-duckdb-examples.org]]
#+end_quote
...
,| _max_rows | 5                                                                               |
,| _url      | https://d37ci6vzurychx.cloudfront.net/trip-data/yellow_tripdata_2025-09.parquet |</pre>Defining a table with variables to be used </td></tr>
