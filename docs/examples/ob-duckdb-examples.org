...
#+begin_quote
[!WARNING]
This file is meant to be seen either [[https://raw.githubusercontent.com/gggion/ob-duckdb/refs/heads/refactor/async-performance/docs/examples/ob-duckdb-examples.org][raw]] or in an org-mode buffer.
